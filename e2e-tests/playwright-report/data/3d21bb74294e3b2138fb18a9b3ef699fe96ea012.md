...
- Name: lessons.spec.ts >> Lessons - Captura >> devorq lessons capture deve criar arquivo JSON
- Location: tests/lessons.spec.ts:37:7
...
Expected pattern: /lesson|Lição|saved/i
Received string:  ""
```
